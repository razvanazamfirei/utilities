*! version 6.4 11JAN2022 DIME Analytics dimeanalytics@worldbank.org
	...
	program ieboilsave , rclass
		...
		syntax ,  IDVARname(varlist) [noDIOUTput missingok tagname taghost]
		...
		preserve
			...
			local idavarnamesize `:list sizeof idvarname'
		...
		*********************************/
		...
		if `idavarnamesize' == 2 {
			local idOut "The uniquely and fully identifying ID variables are `idvarname'. "
		}
